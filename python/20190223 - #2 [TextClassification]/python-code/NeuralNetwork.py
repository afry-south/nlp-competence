...
from competitions.tools.neural_networks import NeuralNetworkClassifier, QRNN
...
# def tokenize_lambda():
#     lambda df_text: tokenize(df_text)
...
"""
# 0.57f1 after 3 epochs, still growing strong.
653061/653061 [==============================] - 2183s 3ms/step - loss: 0.1686 - acc: 0.9431 - precision_score: 0.4781 - recall_score: 0.3200 - f1_score: 0.3694 - roc_auc_score: 0.7942 - val_loss: 0.1454 - val_acc: 0.9481 - val_precision_score: 0.5464 - val_recall_score: 0.4961 - val_f1_score: 0.5159 - val_roc_auc_score: 0.8781
Epoch 2/10
653061/653061 [==============================] - 2121s 3ms/step - loss: 0.1384 - acc: 0.9494 - precision_score: 0.5791 - recall_score: 0.5145 - f1_score: 0.5368 - roc_auc_score: 0.8928 - val_loss: 0.1321 - val_acc: 0.9507 - val_precision_score: 0.5668 - val_recall_score: 0.5695 - val_f1_score: 0.5641 - val_roc_auc_score: 0.9025
Epoch 3/10
652800/653061 [============================>.] - ETA: 0s - loss: 0.1286 - acc: 0.9518 - precision_score: 0.5899 - recall_score: 0.5721 - f1_score: 0.5736 - roc_auc_score: 0.9091^CTraceback (most recent call last):
"""
